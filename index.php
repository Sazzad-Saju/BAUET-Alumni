                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <div class="d-flex mr-auto flex-column flex-lg-row align-items-center">
                                <ul class="navbar-nav">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="./eventshow.php">Program & Events</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="./alumnistory.php">Alumni Post</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="profilecard.php">ALL ALUMNI</a>
                                    </li>
                                    <li class="nav-item">
                            ...
                            <div class="quote_btn-container">
                                ...
                                <form class="form-inline">
                                    <button class="btn my-2 my-sm-0 nav_searsch-btn" type="submit">

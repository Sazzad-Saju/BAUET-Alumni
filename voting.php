  ...
  ?>
    ...
    <div class="card">
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $stmt = $pdo->prepare("INSERT INTO vote_candidates (student_id, name, post, club, image) VALUES (:sid, :sname, :spost, :sclub, :image)");
            ...
            $stmt->bindParam(':spost', $spost);
            $stmt->bindParam(':sclub', $sclub);
        ...
        <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data">
            ...
            <label for="spost">Post</label>
            <input type="text" id="spost" name="spost" required>
            
            <label for="sclub">Club</label>
            <input type="text" id="sclub" name="sclub" required>
